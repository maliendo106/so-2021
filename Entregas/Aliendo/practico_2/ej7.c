...
int main(int argc, char *argv[]) {
    ...
    if( stat_res != 0 ) {
        ...
        printf("Hora ultimo acceso: %s", ctime(&statbuf.st_atime));
        printf("Hora ultima modificacion: %s", ctime(&statbuf.st_atime));
        printf("Hora ultimo cambio: %s", ctime(&statbuf.st_ctime));
